...
<br><div class="$test_selector" style="display: flex; flex-wrap: wrap; justify-content: space-between;">
...
href="/<%= post.rootCategory %>-story/<%= post.assetId %>-<%= post.titleAlias %>/?utm_source=$site&utm_medium=articleinline&utm_campaign=engagement&utm_content=textlink&utm_term=<%= post.assetId %>"> \
<%= post.title %>
</a></p>
</div>
<% } %>
